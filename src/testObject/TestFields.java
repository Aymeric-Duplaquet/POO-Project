...
public class TestFields {
	...
	public TestFields(int heyaInt, boolean heyaBoolean,float heyaFloat,short heyaShort,long heyaLong,byte heyaByte, char heyaChar, String heyaString, double heyaDouble) {
		super();
